    ...
    <main class="flex flex-col items-center justify-center p-4 pb-24 sm:p-6 min-h-screen">
      <div class="mx-auto max-w-lg w-full px-4">
        ...
        >
          ...
          <div class="flex gap-3 flex-col sm:flex-row w-full sm:w-auto items-center justify-center">
            <button
              @click="tryAgain"
              class="inline-flex items-center gap-2 bg-red-600 text-white font-semibold py-2 px-5 rounded-lg shadow hover:bg-red-700 transition-transform transform hover:-translate-y-0.5"
            >
            ...
            <button
              @click="goDashboard"
              class="inline-flex items-center gap-2 bg-[#4A90E2] text-white font-semibold py-2 px-5 rounded-lg shadow hover:bg-[#357ABD] transition"
            >
              Volver al Dashboard
            </button>
          </div>
...
const tryAgain = () => router.push('/plans')
