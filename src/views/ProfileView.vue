<template>
  ...
  >
    <!-- Header -->
    <div
      class="flex items-center border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1a2732] p-4"
    >
    ...
    <main class="flex-1 px-4 py-6 max-w-6xl mx-auto w-full">
      ...
      <div v-else class="space-y-6">
        <!-- User Info Card -->
        <div
          class="bg-white dark:bg-[#1a2732] rounded-xl p-6 border border-gray-200 dark:border-gray-700"
        >
