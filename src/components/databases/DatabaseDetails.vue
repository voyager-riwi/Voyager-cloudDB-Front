    ...
    <div class="relative z-10">
      ...
      <main class="p-4 space-y-8">
        ...
        <section>
          ...
          <div class="bg-white/90 dark:bg-[#1a2732]/95 backdrop-blur-sm rounded-xl shadow-sm">
        ...
        <section>
          ...
          <div
            class="bg-white/90 dark:bg-[#1a2732]/95 backdrop-blur-sm rounded-xl shadow-sm p-4 space-y-4"
          >
