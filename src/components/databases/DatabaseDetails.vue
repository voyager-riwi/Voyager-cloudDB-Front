    ...
    <div class="relative z-10">
      ...
      <main class="p-4 space-y-8">
        ...
        <section>
          ...
          <div class="bg-white/90 dark:bg-[#111c22]/90 backdrop-blur-sm rounded-xl shadow-sm">
        ...
        <section>
          ...
          <div
            class="bg-white/90 dark:bg-[#111c22]/90 backdrop-blur-sm rounded-xl shadow-sm p-4 space-y-4"
          >
            <!-- Security Warning -->
        ...
        <section class="space-y-4 pt-4">
          <button
            ...
            class="w-full flex items-center justify-center gap-2 h-12 px-6 font-semibold rounded-lg bg-[#1193d4]/20 text-[#1193d4] dark:bg-[#1193d4]/20 dark:text-[#1193d4] hover:bg-[#1193d4]/30 transition-colors backdrop-blur-sm"
          >
          ...
          <button
            ...
            class="w-full flex items-center justify-center gap-2 h-12 px-6 font-semibold rounded-lg bg-red-500/10 text-red-600 dark:bg-red-500/20 dark:text-red-400 hover:bg-red-500/20 dark:hover:bg-red-500/30 transition-colors backdrop-blur-sm"
          >
...
const currentEngine = computed(() => {
  if (!database.value.version) return null
  return DATABASE_ENGINES.find(
    (engine) => engine.name.toLowerCase() === database.value.version.toLowerCase(),
  )
})
...
const backgroundStyle = computed(() => {
  const backgroundImage = currentEngine.value?.details_bg
    ...
    : 'linear-gradient(135deg, #101c22  0%, #101c22)'
