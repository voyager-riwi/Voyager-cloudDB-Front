<template>
  <div class="fixed inset-0 z-50 overflow-y-auto">
    ...
    <div class="relative min-h-screen flex items-center justify-center p-4">
      <div
        class="relative bg-white/80 backdrop-blur-md rounded-xl w-full max-w-2xl shadow-2xl overflow-hidden"
      >
        <!-- Header -->
                ...
                <div
                  ...
                  :class="
                    selectedEngine === engine.id
                      ...
                      : 'border-slate-200 dark:border-slate-700 hover:border-primary/50 bg-white/80 backdrop-blur-md'
                  "
                >
                  <!-- Logo -->
                  <div
        ...
        <!-- Footer -->
        <div
          class="p-6 bg-slate-50/80 backdrop-blur-md border-t border-slate-200 dark:border-slate-700"
        >
          <button
